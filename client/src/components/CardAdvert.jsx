    ...
    <div className={`flex flex-col`}>
      ...
      >
        <div className="flex flex-col gap-[4px]">
          ...
          <div
            className={`mb-2 p-1 cursor-pointer flex flex-row justify-center items-center w-[280px] bg-mediumspringgreen hover:opacity-90 text-white h-[49px] shrink-0 rounded-md outline outline-lightslategray-300 outline-[1px]`}
