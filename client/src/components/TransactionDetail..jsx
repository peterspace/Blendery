...
export const TransactionDetail = () => {
          ...
          <div className="flex flex-row">
            ...
            <div className="flex flex-col justify-start w-[50%]">
              ...
              <div className="flex flex-row gap-2 mt-2">
                ...
                <div className="cursor-pointer flex flex-row justify-center items-center bg-bgSecondary hover:opacity-90 text-bgPrimary h-[49px] shrink-0 rounded w-[30%]">
                  Next
                </div>
              </div>
            </div>
      ...
      <div className="flex flex-col gap-[24px]">
        <div className="flex flex-col gap-[8px] md:gap-[12px]">
          <div className="flex flex-row justify-between mt-[24px]">
            ...
            <div className="cursor-pointer flex flex-row justify-center items-center bg-bgSecondary hover:opacity-90 text-bgPrimary shrink-0 rounded px-6 py-3">
              Back
            </div>
          </div>
          <div className="flex bg-lightslategray-300 md:w-[452px] w-[370px] h-px" />
  ...
  const progressBarAnimation4Stages = (
    <>
      ...
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[25%] h-[12px] z-10" />
      </div>
      {/* ========================{step 2 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[50%] h-[12px] z-10" />
      </div>
      {/* ========================{step 3 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[75%] h-[12px] z-10" />
      </div>
      {/* ========================{step 4 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[100%] h-[12px] z-10" />
      </div>
    </>
  );
  const progressBarAnimation3Stages = (
    <>
      {/* ========================{step 2 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[35%] h-[12px] z-10" />
      </div>
      {/* ========================{step 3 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[70%] h-[12px] z-10" />
      </div>
      {/* ========================{step 4 of 4}===================================== */}
      <div className="flex flex-row w-[276px] bg-lightslategray-300 rounded-lg">
        <div className="flex bg-bgPrimary rounded-lg w-[100%] h-[12px] z-10" />
    ...
    <div className="flex justify-center rounded-lg w-[228px] p-4 bg-gray-100">
      <div className="flex flex-row gap-2 w-full">
        <div className="flex justify-center items-center w-[24px] h-[24px] flex-shrink-0 bg-gainsboro-100 p-1 rounded">
          <div className="text-xs leading-[17px] font-sans font-bold text-bgPrimary inline-block w-[7px]">
            1
          </div>
        </div>
