...
import { ColumnsUserRecords } from '../Tanstack/ColumnsUserRecords';
const menu = [
  {
    name: 'Bitcoin',
  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-1 p-1">
        ...
        {page === 'Buy (Cash)' && allBuyCashTransactions && (
          <UserRecord
            columns={ColumnsUserRecords}
        ...
        {page === 'Buy (Card)' && allBuyCardTransactions && (
          <UserRecord
            columns={ColumnsUserRecords}
        ...
        {page === 'Sell (Cash)' && allSellCashTransactions && (
          <UserRecord
            columns={ColumnsUserRecords}
        ...
        {page === 'Sell (Card)' && allSellCardTransactions && (
          <UserRecord
            columns={ColumnsUserRecords}
