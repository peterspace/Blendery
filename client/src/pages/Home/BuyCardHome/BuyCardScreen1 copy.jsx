          ...
          <div className="flex flex-col w-[300px] md:w-[452px] gap-[8px]">
            <div className="grid grid-cols-2 gap-2 mt-2 rounded-lg shadow-[0px_2px_4px_rgba(26,_47,_79,_0.2)] p-1 bg-gray-100 outline outline-lightslategray-300 outline-[1px]">
              <div
                ...
                //   paymentMethod === 'card'
                //     ? 'bg-bgPrimary hover:opacity-90 text-white outline-lightslategray-300'
                //     : 'bg-whitesmoke-200 shadow-md hover:bg-whitesmoke-100'
                // }`}
                className={`cursor-pointer flex flex-row justify-center items-center h-[49px] ${
                  paymentMethod === 'card'
                    ? 'cursor-pointer text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                    : 'cursor-pointer text-gray-900 focus:outline-none bg-white rounded border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700'
                }`}
                onClick={() => setPaymentMethod(paymentOptions[0])}
              >
                <div
                  // className={`flex flex-row gap-2 ${
                  //   paymentMethod === 'card' ? 'text-white' : 'text-bgPrimary'
                  // }`}
              ...
              <div
                ...
                onClick={() => setPaymentMethod(paymentOptions[1])}
              >
                <div
                  // className={`flex flex-row gap-2 ${
                  //   paymentMethod === 'cash' ? 'text-white' : 'text-bgPrimary'
                  // }`}
                  className={`flex flex-row gap-2`}
                >
                  <BsCashStack size={20} />
