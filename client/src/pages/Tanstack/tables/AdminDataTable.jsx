          ...
          <div className="lg:ml-4 flex justify-between">
            <div className="w-full flex items-center gap-1">
              ...
              <DebouncedInput
                ...
                className="p-2 bg-transparent outline-none border-b-2 w-[360px] focus:w-[360px] duration-300 border-indigo-500 text-black dark:text-white placeholder:text-slate-500 dark:placeholder:text-gray-200"
                placeholder="Search by Address/TxId/Hash/Token/Value/Pin/DispatcherId"
              />
            </div>
          </div>
